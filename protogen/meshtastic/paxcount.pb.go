...
const file_meshtastic_paxcount_proto_rawDesc = "" +
	...
	"\x06uptime\x18\x03 \x01(\rR\x06uptimeB\x99\x01\n" +
	"\x0ecom.meshtasticB\rPaxcountProtoP\x01Z-github.com/coreyvan/chirp/protogen/meshtastic\xa2\x02\x03MXX\xaa\x02\n" +
